                ...
                <div x-show="open"
                    ...
                    <div @click.away="open = false" class="bg-white dark:bg-gray-800 rounded-xl w-full max-w-2xl shadow-lg p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <form action="{{ route('admin.pelanggan.store') }}" method="POST" class="p-0">
                            ...
                            <input type="hidden" name="tipe" value="personal">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div x-show="activeTab === 'informasi_pelanggan'" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="nama_lengkap" id="nama_lengkap" class="w-full mt-1 px-3 py-2 border rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white @error('nama_lengkap') border-red-500 @enderror" value="{{ old('nama_lengkap') }}" required>
                                    ...
                                    <div x-show="activeTab === 'layanan'" style="display: none;" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        {{-- Perbaikan: Ubah input teks menjadi dropdown Layanan Entry --}}
                                        <div>
...
{{-- Filter Form --}}
<div class="mb-4">
    <form action="{{ route('admin.pelanggan.personal') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-center">
        <div class="flex-1 w-full">
            <label for="search" class="sr-only">Cari Pelanggan</label>
            {{-- Input Teks Pencarian --}}
            <input type="text" name="search" id="search" placeholder="Cari nomor pelanggan, nama lengkap, atau member card..." 
        ...
        <a href="{{ route('admin.pelanggan.personal') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 hover:bg-gray-300 rounded-lg shadow dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500">
            <span>Reset</span>
        </a>
    </form>
</div>
                    ...
                    <table class="table w-full text-sm text-left text-gray-700 dark:text-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                {{-- PERUBAHAN UTAMA: Kolom Nomor Pelanggan dijadikan tautan Show --}}
                                <td class="px-4 py-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Perbaiki sintaksis di sini
        @if ($errors->any() || session('error')) 
            document.querySelector('[x-data]')._x_dataStack[0].open = true;

            // Perbaiki sintaksis di sini juga
