                            ...
                            @forelse($pelanggan as $index => $p)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 flex gap-2">
                                        ...
                                        <a href="{{ route('admin.pelanggan.show', ['id' => $p->id, 'type' => 'personal']) }}"
                                        ...
                                        <a href="{{ route('admin.pelanggan.edit', ['id' => $p->id, 'type' => 'personal']) }}"
...
{{-- Pastikan Font Awesome dimuat, biasanya di layout utama --}}
