    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'biaya_setup' => 'required|numeric|min:0',
                'biaya_reguler_1_bulan' => 'required|numeric|min:0',
                'biaya_reguler_3_bulan' => 'required|numeric|min:0',
                'bonus_reguler_3_bulan' => 'nullable|string',
                'biaya_reguler_6_bulan' => 'required|numeric|min:0',
                'bonus_reguler_6_bulan' => 'nullable|string',
                'biaya_reguler_12_bulan' => 'required|numeric|min:0',
                ...
                'biaya_reguler_1' => 'required|numeric|min:0',
                'account_myob_2' => 'nullable|string',
                'biaya_reguler_2' => 'required|numeric|min:0',
