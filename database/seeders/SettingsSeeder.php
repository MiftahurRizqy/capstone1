...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('settings')->insert([ 
            ...
            // Sidebar colors
            ['option_name' => 'sidebar_bg_lite', 'option_value' => '#3b6790'],
            ...
            // Navbar colors
            ['option_name' => 'navbar_bg_lite', 'option_value' => '#3b6790'],
            ...
            ['option_name' => 'site_icon', 'option_value' => '/images/logo/kecil.png'],
            ['option_name' => 'site_favicon', 'option_value' => '/images/logo/kecil.png'],
