...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('layanan_entry', function (Blueprint $table) {
            ...
            $table->decimal('biaya_setup', 15, 2)->default(0);
            $table->decimal('biaya_reguler_1_bulan', 15, 2)->default(0);
            $table->decimal('biaya_reguler_3_bulan', 15, 2)->default(0);
            $table->enum('bonus_reguler_3_bulan', ['1 Bulan', '2 Bulan', '3 Bulan', '4 Bulan', '5 Bulan', '6 Bulan'])->nullable();
            $table->decimal('biaya_reguler_6_bulan', 15, 2)->default(0);
            $table->enum('bonus_reguler_6_bulan', ['1 Bulan', '2 Bulan', '3 Bulan', '4 Bulan', '5 Bulan', '6 Bulan'])->nullable();
            $table->decimal('biaya_reguler_12_bulan', 15, 2)->default(0);
            ...
            $table->decimal('biaya_reguler_1', 15, 2)->default(0)->nullable();
            $table->string('account_myob_2')->nullable();
            $table->decimal('biaya_reguler_2', 15, 2)->default(0)->nullable();
